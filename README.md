...
Enjoy [cellular automata](https://en.wikipedia.org/wiki/Cellular_automaton) with an interactive implementation of [Conway's Game of Life](https://en.wikipedia.org/wiki/Conway%27s_Game_of_Life) built with Flask and vanilla JavaScript. 
